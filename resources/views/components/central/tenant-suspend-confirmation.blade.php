...
<dialog id="{{ $dialogId }}" class="w-[min(92vw,520px)] rounded-3xl border border-zinc-200 bg-white p-0 text-zinc-950 shadow-2xl backdrop:bg-zinc-950/50 dark:border-zinc-700 dark:bg-zinc-900 dark:text-white">
