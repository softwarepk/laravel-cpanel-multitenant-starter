...
<x-ui.blocking-operation id="tenant-provision-progress" scope="tenant-operation-scope" eyebrow="Provisioning" title="Provisioning tenant" message="Reading current provisioning status…" />
<x-ui.blocking-operation id="tenant-delete-progress" scope="tenant-operation-scope" eyebrow="Permanent deletion" title="Deleting tenant" message="Reading current deletion status…" />
...
<div id="tenant-operation-scope" class="transition-opacity">
    ...
    <div id="tenant-workspace" class="grid gap-6 xl:grid-cols-[minmax(0,1.25fr)_minmax(340px,.75fr)]">
        <div class="space-y-6">
