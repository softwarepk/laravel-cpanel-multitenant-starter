...
class DeleteTenant
{
    ...
    public function handle(Tenant $tenant, ?CentralAdmin $admin = null): TenantDeletionRecord
    {
        ...
        $this->persistProgress($history, $results);
    ...
    /** @param array<string, array{status:string,target:mixed,error?:string}> $results */
    private function persistProgress(TenantDeletionRecord $history, array $results): void
    {
