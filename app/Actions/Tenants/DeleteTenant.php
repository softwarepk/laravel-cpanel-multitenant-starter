...
class DeleteTenant
{
    ...
    public function handle(Tenant $tenant): void
    {
        ...
        if (File::isDirectory($storagePath) && ! File::deleteDirectory($storagePath)) {
            throw new RuntimeException('Tenant storage could not be deleted. No database or control-plane records were removed.');
        }
        if ($database !== '') {
